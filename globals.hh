...
class Global_Data {
    ...
    void store_all_to_disk(string directory, string filename_prefix) {
        revbwt->save_to_disk(directory, filename_prefix + "_rev_bwt");
        
        slt_bpr->serialize(directory + "/" + filename_prefix + "_slt_bpr");
        rev_st_bpr->serialize(directory + "/" + filename_prefix + "_rev_st_bpr");
        rev_st_bpr_context_only->serialize(directory + "/" + filename_prefix + "_rev_st_bpr_context_only");
        rev_st_maximal_marks->serialize(directory + "/" + filename_prefix + "_rev_st_maximal_marks");
        slt_maximal_marks->serialize(directory + "/" + filename_prefix + "_slt_maximal_marks");
        rev_st_context_marks->serialize(directory + "/" + filename_prefix + "_rev_st_context_marks");
        pruning_marks->serialize(directory + "/" + filename_prefix + "_pruning_marks");
        
    }

    // DOES NOT STORE string_depths!
    void load_all_from_disk(string directory, string filename_prefix, bool run_length_coding) {
        ...
        revbwt->load_from_disk(directory, filename_prefix + "_rev_bwt");
        
        slt_bpr->load(directory + "/" + filename_prefix + "_slt_bpr");
        rev_st_bpr->load(directory + "/" + filename_prefix + "_rev_st_bpr");
        rev_st_bpr_context_only->load(directory + "/" + filename_prefix + "_rev_st_bpr_context_only");
        rev_st_maximal_marks->load(directory + "/" + filename_prefix + "_rev_st_maximal_marks");
        slt_maximal_marks->load(directory + "/" + filename_prefix + "_slt_maximal_marks");
        rev_st_context_marks->load(directory + "/" + filename_prefix + "_rev_st_context_marks");
        pruning_marks->load(directory + "/" + filename_prefix + "_pruning_marks");
