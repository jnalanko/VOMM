...
* `--maxreps-pruning` Keeps just maximal repeats in the topologies, and run-length-encodes the balanced-parentheses representation of the suffix-link tree (see the bioRxiv paper for more details).
